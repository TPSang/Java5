...
<head>
<title>Lab6 Search & Page (DSL)</title>
<!-- Required meta tags -->
<meta charset="utf-8">
<meta name="viewport"
...
<body class="bg-dark" ng-app="myApp">
	<div class="container m-auto">
		...
		<div class="container bg-white text-center">
			<h3>SEARCH & PAGE</h3>
			<form class="row mb-2" action="/product/search-and-page1"
				method="post">
			...
			<div class="m-2">
				<a class="btn btn-primary" href="/product/search-and-page1?p=0">First</a>
				<a class="btn btn-primary"
					href="/product/search-and-page1?p=${page.number-1}">Previous</a> <a
					class="btn btn-primary"
					href="/product/search-and-page1?p=${page.number+1}">Next</a> <a
					class="btn btn-primary"
					href="/product/search-and-page1?p=${page.totalPages-1}">Last</a>
			</div>
